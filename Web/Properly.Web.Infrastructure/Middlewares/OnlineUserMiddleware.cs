...
namespace Properly.Web.Infrastructure.Middlewares
{
    public class OnlineUsersMiddleware
    {
        ...
        public OnlineUsersMiddleware(RequestDelegate next,
            string cookieName = GlobalConstants.OnlineUsersCookieName,
            int lastActivityMinutes = GlobalConstants.LastActivityBeforeOfflineMinutes)
        {
            this.next = next;
